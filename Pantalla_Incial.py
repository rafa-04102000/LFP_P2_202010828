...
from tkinter import Tk, SOLID, Frame,Label,Button,Toplevel,Canvas
import time
import random
...
class Inicio(Frame):
    def __init__(self, master) -> None:
        ...
        self.colores = ['snow', 'ghost white', 'white smoke', 'gainsboro', 'floral white', 'old lace',
        ...
        self.canvas1= Canvas(self.frame1, bg='gray40', width=150, height =150,highlightthickness=0)
        self.texto1 = self.canvas1.create_text(74,67,text='5', font=('Arial',55,'bold'), fill= 'White')
        self.circulo1 = self.canvas1.create_oval(30,15,120,110, outline='red2',width=10)
    ...
    def crear_contenido(self):
        label0 = Label(self, text="Spark Stack",font=('Arial',15,'bold'),relief=SOLID)
        label0.place(relx=0.20,rely=0.05,width=300,height=50)

        label1 = Label(self, text="Lenguajes Formalaes y De Programacion N\r 202010828\r Tobías Rafael Zamora Santos",relief=SOLID)
        label1.place(relx=0.20,rely=0.22,width=300,height=100)


        texto_segundos = self.canvas1.create_text(75,130, text='Segundos',font=('Arial',15,'bold'), fill= 'White')

        self.frame1.place(relx=0.35,rely=0.55)
